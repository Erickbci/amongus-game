startReactor = {
    ...
    interface: {
        ...
        playerMemoryButtons: document.querySelector(".playerMemoryButtons"),
        ...
        playItem(index, comnbinationPosition, location = 'computer') {
            ...
            startReactor.interface.turnLedOn(comnbinationPosition, leds)
